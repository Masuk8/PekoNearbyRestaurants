...
#ifndef PEKONEARBYRESTAURANTS_SWIFT_H
#define PEKONEARBYRESTAURANTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PekoNearbyRestaurants",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21PekoNearbyRestaurants11AppDelegate")
...
@interface MapViewController (SWIFT_EXTENSION(PekoNearbyRestaurants)) <CLLocationManagerDelegate>
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified homePageButton;
...
SWIFT_CLASS("_TtC21PekoNearbyRestaurants13SceneDelegate")
...
SWIFT_CLASS("_TtC21PekoNearbyRestaurants10UserMarker")
@interface UserMarker : GMSMarker
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC21PekoNearbyRestaurants16UserMarkerWindow")
@interface UserMarkerWindow : UIView
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified nameLbl;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified surnameLbl;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified birthDateLbl;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified editNameButton;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified editSurnameButton;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified editBirthDateButton;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
